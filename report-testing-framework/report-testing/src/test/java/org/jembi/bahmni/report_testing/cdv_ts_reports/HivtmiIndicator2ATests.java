...
public class HivtmiIndicator2ATests extends BaseReportTest {
    ...
    public void shouldCountPatientWhoWithdrewHIVResults() throws Exception {
        ...
        String query = readReportQuery(ReportEnum.CDV_TS_REPORT,
            "indicator2_CDV_TS_number_of_people_who_withdrew_their_results_in_the_month.sql",
            new LocalDate(2022, 11, 1),
            new LocalDate(2022, 11, 30));
        List<Map<String, Object>> result = getReportResult(query);

        // Assert
        assertEquals(result.get(0).get("Title"), "Number of people who withdrew their results in the month");
    ...
    @Test
    public void shouldNotCountPatientWhoDidNotWithdrawHivResults() throws Exception {
        // register a new patient
        int patientId = testDataGenerator.registration.createPatient(
            GenderEnum.MALE,
            new LocalDate(2000, 9, 1),
