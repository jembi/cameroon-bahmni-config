...
public class HivtmiIndicator1Tests extends BaseReportTest {
    ...
    public void shouldCountHivPatient() throws Exception {
        ...
        String query = readReportQuery(ReportEnum.CDV_TS_REPORT, "indicator1_CDV_TS_number_of_people_tested_in_the_month.sql", new LocalDate(2022, 11, 1), new LocalDate(2022, 11, 30));
		List<Map<String,Object>> result = getReportResult(query);

        // Assert
		assertEquals(result.get(0).get("Title"), "Number of people tested in the month");
