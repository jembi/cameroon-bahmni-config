...
public class HivtmiIndicator5Tests extends BaseReportTest {
    @Test
    public void shouldCountHivPatient() throws Exception {
        ...
        testDataGenerator.hivTestingAndCounsellingForm.setHTCFinalResult(
            ...
            String query = readReportQuery(ReportEnum.CDV_TS_REPORT, "indicator5_CDV_TS_number_of_indeterminate_results_in_the_month.sql", new LocalDate(2022, 11, 1), new LocalDate(2022, 11, 30));
            List<Map<String,Object>> result = getReportResult(query);
    
            // Assert
            assertEquals(result.get(0).get("Title"), "Number of indeterminate results in the month");
