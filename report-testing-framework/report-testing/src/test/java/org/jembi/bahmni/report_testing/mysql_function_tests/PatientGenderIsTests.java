...
public class PatientGenderIsTests extends BaseReportTest {
	...
	public void shouldReturnOneWhenPatientIsMale() throws Exception {
		// Prepare
		int personId = testDataGenerator.createPerson(GenderEnum.MALE, new LocalDate(2000, 9, 1), "Leon", "Aziza");
	...
	public void shouldReturnOneWhenPatientIsFemale() throws Exception {
		// Prepare
		int personId = testDataGenerator.createPerson(GenderEnum.FEMALE, new LocalDate(2000, 9, 1), "Louise", "Palaku");
	...
	public void shouldReturnZeroWhenPatientIsNotMale() throws Exception {
		// Prepare
		int personId = testDataGenerator.createPerson(GenderEnum.FEMALE, new LocalDate(2000, 9, 1), "Jeff", "Wena");
	...
	public void shouldReturnZeroWhenPatientIsNotFemale() throws Exception {
		// Prepare
		int personId = testDataGenerator.createPerson(GenderEnum.MALE, new LocalDate(2000, 9, 1), "Chris", "Kutamina");
