...
public class GeorgetownPatientInformationReportTests extends BaseReportTest {
    ...
    /** the column "Regiment at ART Initiation" is retrieved from a different concept when the patient is a child */
    @Test
    ...
    /** when the sexual orientation is not populated, the column "KP?" should = "False" */
    @Test
    ...
    /** when the patient is eligible for VL, the column "Eligibilty for VL" should = "Yes" */
    @Test
