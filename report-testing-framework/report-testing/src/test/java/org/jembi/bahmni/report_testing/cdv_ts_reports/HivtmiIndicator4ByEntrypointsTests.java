...
public class HivtmiIndicator4ByEntrypointsTests extends BaseReportTest {
    ...
    public void shouldCountHivPatientByEntryPoints() throws Exception {
        ...
        // Assert
		assertEquals(result.get(0).get("Title"), "Number of people tested positive started on ART among people tested positive in the month disaggregated by entry point");
