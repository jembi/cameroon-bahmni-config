SELECT
    ...
    DATE(getProgramAttributeValueWithinReportingPeriod(p.patient_id, "#startDate#", "#endDate#", "c4e1106e-1644-45be-86c2-88392e73a507")) as "Date of Notification",
    ...
    DATE(getProgramAttributeValueWithinReportingPeriod(p.patient_id, "#startDate#", "#endDate#", "2dc1aafd-a708-11e6-91e9-0800270d80ce")) as "Date of Initiation",
