SELECT
    ...
    "GestationAgeAtSampleCollection",
    "DateOfResultReception",
    "DateOfResultReception1",
    "DateOfSampleCollection1",
    "GestationAgeAtSampleCollection1",
    "ViralLoadResult1",
    "ViralLoadResultType1",
    "DateOfSampleCollection2",
    "GestationAgeAtSampleCollection2",
    "ViralLoadResult2",
    "ViralLoadResultType2",
    "DateOfCD4SampleCollection",
    "CD4Result",
    ...
    "dateOfOutcome",
    "siteCodeOfFacilityTransferredTo",
    "Comment"
