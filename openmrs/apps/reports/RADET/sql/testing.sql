SELECT "N/A" AS "HTS Client ID (EID or HEI Number)",
	...
	getMostRecentShortNameCodedObservation(p.patient_id,"HTC, Pregnancy Status","en") as "Pregnancy Status/état de grossesse ",
	getRadetRiskGroup(p.patient_id) as "KP Status/ Statut KP ",
