SELECT
  ...
  PECG_Indicator10('#startDate#','#endDate#', 25, 29,  1, 'M') AS '25-29 M',
  PECG_Indicator10('#startDate#','#endDate#', 25, 29,  1, 'F') AS '25-29 F',
  PECG_Indicator10('#startDate#','#endDate#', 30, 34,  1, 'M') AS '30-34 M',
  PECG_Indicator10('#startDate#','#endDate#', 30, 34,  1, 'F') AS '30-34 F',
  PECG_Indicator10('#startDate#','#endDate#', 35, 39,  1, 'M') AS '35-39 M',
  PECG_Indicator10('#startDate#','#endDate#', 35, 39,  1, 'F') AS '35-39 F',
  PECG_Indicator10('#startDate#','#endDate#', 40, 44,  1, 'M') AS '40-44 M',
  PECG_Indicator10('#startDate#','#endDate#', 40, 44,  1, 'F') AS '40-44 F',
  PECG_Indicator10('#startDate#','#endDate#', 45, 49,  1, 'M') AS '45-49 M',
  PECG_Indicator10('#startDate#','#endDate#', 45, 49,  1, 'F') AS '45-49 F',
