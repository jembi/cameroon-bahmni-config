SELECT
  'Number of people tested in the month disaggregated by entry point' AS 'Title',
        ...
        HIVTMI_Indicator1_disaggregated_by_anc_entry_point('#startDate#','#endDate#') AS 'CPN / ANC',
        ...
        HIVTMI_Indicator1_disaggregated_by_other_entry_point('#startDate#','#endDate#') AS 'Other entry Points';