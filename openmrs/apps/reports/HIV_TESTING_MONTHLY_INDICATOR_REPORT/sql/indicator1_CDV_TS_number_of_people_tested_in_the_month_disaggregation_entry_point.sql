SELECT
  'Number of people tested in the month disaggregated by entry point' AS 'Title',
        ...
        HIVTMI_Indicator1_disaggregated_by_single_entry_point('#startDate#','#endDate#','LOCATION_EMERGENCY') AS 'Emergency',
        ...
        HIVTMI_Indicator1_disaggregated_by_single_entry_point('#startDate#','#endDate#','Paediatric') AS 'Pediatrics',
