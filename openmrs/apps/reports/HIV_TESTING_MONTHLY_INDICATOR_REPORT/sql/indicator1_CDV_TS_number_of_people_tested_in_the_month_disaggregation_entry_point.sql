SELECT
  'Number of people tested in the month disaggregated by entry point' AS 'Title',
        ...
        HIVTMI_Indicator3_disaggregated_by_entry_point('#startDate#','#endDate#','LOCATION_EMERGENCY') AS 'Emergency',
        ...
        HIVTMI_Indicator3_disaggregated_by_entry_point('#startDate#','#endDate#','Other testing at TB Unit') AS 'Other testing at TB Unit',
