SELECT
    ...
    getNumberOfScheduledAppointmentsDuringReportingPeriod(pat.patient_id,"#startDate#","#endDate#","APPOINTMENT_SERVICE_ART_KEY") as "Nr. Of ART Visits",
    getNumberOfScheduledAppointmentsDuringReportingPeriod(pat.patient_id,"#startDate#","#endDate#","APPOINTMENT_SERVICE_ART_DISPENSARY_KEY") as "Nr. Of ART Dispensary Visits",
    getDateOfLastScheduledARTOrARTDispensaryAppointment(pat.patient_id) as "Date of Last ART or ART Dispensary Visit",
