SELECT
    ...
    getProgramAttributeValueWithinReportingPeriod(p.patient_id, "#startDate#", "#endDate#", "404b652e-6002-4371-8427-3e9e84cdf454") as "Other tracking outcomes",
    getOtherReasonsOfDefaulting(p.patient_id) as "Reason for defaulting",
    getProgramAttributeValueWithinReportingPeriod(p.patient_id, "#startDate#", "#endDate#", "37a86762-3eae-4c00-a004-6589407d0de1") as "Other reasons for defaulting",
    DATE(getProgramAttributeValueWithinReportingPeriod(p.patient_id, "#startDate#", "#endDate#", "b04fb0b8-3a1c-46fa-bf83-922513016b6b")) as "Date promised to return"
