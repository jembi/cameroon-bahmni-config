SELECT
    ...
    getObsCodedValue(p.patient_id, "67d7ed45-8c77-4cce-8bc2-03ea5d15490f") as "dateOfDeathNotification",
...
WHERE
    getObsCodedValue(p.patient_id, "67d7ed45-8c77-4cce-8bc2-03ea5d15490f") BETWEEN "#startDate#" AND "#endDate#";